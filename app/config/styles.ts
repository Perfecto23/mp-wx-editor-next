...
export const STYLES: StylesConfig = {
  'wechat-default': {
    name: '默认公众号风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 10px 12px 20px 12px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 16px; line-height: 1.8 !important; color: #3f3f3f !important; word-wrap: break-word;',
  ...
  'wechat-anthropic': {
    name: 'Claude',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 20px 24px 40px 24px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "Helvetica Neue", Arial, sans-serif; font-size: 17px; line-height: 1.75 !important; color: #2b2b2b !important; word-wrap: break-word; letter-spacing: -0.01em;',
  ...
  'wechat-tech': {
    name: '技术风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 10px 20px 20px 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 16px; line-height: 1.75 !important; color: #2c3e50 !important; word-wrap: break-word;',
  ...
  'wechat-elegant': {
    name: '优雅简约',
    styles: {
      container: 'max-width: 720px; margin: 0 auto; padding: 12px 20px 30px 20px; font-family: "Songti SC", "SimSun", Georgia, serif; font-size: 17px; line-height: 1.85 !important; color: #333 !important; word-wrap: break-word;',
  ...
  'hische-editorial': {
    name: 'Hische·编辑部',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 20px 20px 50px 20px; font-family: "Crimson Text", Garamond, serif; font-size: 17px; line-height: 1.75 !important; color: #2c2c2c !important; word-wrap: break-word;',
  ...
  'sspai-geek': {
    ...
    styles: {
      ...
      img: 'max-width: 100%; max-height: 400px !important; height: auto; display: block; margin: 20px auto; border-radius: 4px;',
  ...
  'bauhaus-geometric': {
    name: '包豪斯·几何',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 20px; font-family: "Helvetica Neue", Arial, sans-serif; font-size: 15px; line-height: 1.7 !important; color: #000 !important; word-wrap: break-word;',
      h1: 'font-size: 26px; font-weight: 700; color: #000 !important; line-height: 1.2 !important; margin: 36px 0 18px; text-transform: uppercase; letter-spacing: 0.1em; padding-bottom: 10px; border-bottom: 4px solid #e74c3c;',
      h2: 'font-size: 20px; font-weight: 700; color: #e74c3c !important; line-height: 1.3 !important; margin: 32px 0 16px; letter-spacing: 0.05em;',
      h3: 'font-size: 17px; font-weight: 700; color: #2980b9 !important; line-height: 1.35 !important; margin: 28px 0 14px;',
      h4: 'font-size: 16px; font-weight: 700; color: #000 !important; line-height: 1.4 !important; margin: 24px 0 12px;',
      h5: 'font-size: 15px; font-weight: 700; color: #000 !important; line-height: 1.4 !important; margin: 20px 0 10px;',
      h6: 'font-size: 15px; font-weight: 600; color: #000 !important; line-height: 1.4 !important; margin: 18px 0 9px;',
      p: 'margin: 16px 0 !important; line-height: 1.7 !important; color: #000 !important;',
      strong: 'font-weight: 700; color: #e74c3c !important;',
      em: 'font-style: italic; color: #000 !important;',
      a: 'color: #2980b9 !important; text-decoration: none; border-bottom: 2px solid #2980b9;',
      ul: 'margin: 16px 0; padding-left: 24px; list-style-type: square;',
      ol: 'margin: 16px 0; padding-left: 24px; list-style-type: decimal;',
      li: 'margin: 8px 0; line-height: 1.7 !important; color: #000 !important;',
      blockquote: 'margin: 16px 0; padding: 12px 16px; background-color: #fffdf0 !important; border-left: 5px solid #f1c40f; color: #000 !important; line-height: 1.6 !important;',
      code: 'font-family: Consolas, Monaco, "Courier New", monospace; font-size: 14px; padding: 2px 6px; background-color: #f5f5f5 !important; color: #2980b9 !important;',
      pre: 'margin: 20px 0; padding: 16px; background-color: #000 !important; color: #fff !important; overflow-x: auto; line-height: 1.5 !important;',
      hr: 'margin: 30px 0; border: none; height: 4px; background-color: #000 !important;',
      img: 'max-width: 100%; max-height: 400px !important; height: auto; display: block; margin: 20px auto;',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 14px;',
      th: 'background-color: #e74c3c !important; color: #fff !important; padding: 10px; text-align: left; border: 1px solid #e74c3c; font-weight: 700;',
      td: 'padding: 10px; border: 1px solid #ddd; color: #000 !important;',
  ...
  'baoyu-ai': {
    name: '宝玉AI',
    styles: {
      container: 'max-width: 677px; margin: 0 auto; padding: 0; font-family: "PingFang SC", -apple-system-font, system-ui, "Helvetica Neue", "Hiragino Sans GB", "Microsoft YaHei", sans-serif; font-size: 15px; line-height: 1.75 !important; color: #3f3f3f !important; word-wrap: break-word; text-align: justify;',
      h1: 'font-size: 20px; font-weight: 500; color: rgba(0,0,0,0.9) !important; line-height: 1.4 !important; margin: 0 0 14px; letter-spacing: 0.544px;',
      h2: 'font-size: 15px; font-weight: 700; color: #fff !important; line-height: 1.75 !important; margin: 64px auto 32px; padding: 0 3.2px; background-color: #0F4C81 !important; display: table; text-align: center; letter-spacing: 0.544px;',
      h3: 'font-size: 15px; font-weight: 700; color: #3f3f3f !important; line-height: 1.2 !important; margin: 32px 8px 12px 0; padding-left: 8px; border-left: 3px solid #0F4C81; letter-spacing: 0.544px;',
      ...
      p: 'margin: 24px 8px !important; line-height: 1.75 !important; color: #3f3f3f !important; letter-spacing: 1.6px; text-align: left; font-size: 15px;',
      ...
      li: 'margin: 3.2px 8px; line-height: 1.75 !important; color: #3f3f3f !important; letter-spacing: 0.544px; font-size: 15px;',
      ...
      code: 'font-family: Consolas, Monaco, "Courier New", monospace; font-size: 13px; padding: 2px 6px; background-color: #f5f5f5 !important; color: #0F4C81 !important; border-radius: 3px;',
      pre: 'margin: 20px 0; padding: 16px; background-color: #2d2d2d !important; border-radius: 8px; overflow-x: auto; line-height: 1.6 !important;',
